        ...
        <div className="foot-top">
          <div>
            ...
            <p className="foot-blurb">
              A senior digital studio designing and building software, brands
              and infrastructure from Kathmandu, Nepal — for teams worldwide.
            </p>
          </div>
          <div>
            <h5>Studio</h5>
          ...
          <div>
            ...
            <ul>
              <li>
                <Link href="mailto:hello@yetinepal.com">
                  hello@yetinepal.com
                </Link>
              </li>
              <li>
                <Link href="#">Naxal, Kathmandu</Link>
              </li>
              <li>
                <Link href="#">+977 1 4000000</Link>
              </li>
            </ul>
          </div>
        </div>
